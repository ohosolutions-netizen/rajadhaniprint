      ...
      <table className="items-table" style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
        <thead>
          <tr>
            ...
            <th style={{ width: '6%', border: borderStyle }}>Barcode</th>
            <th style={{ width: '42%', border: borderStyle }}>Description of Goods</th>
            ...
            <th style={{ width: '15%', border: borderStyle }}>Total</th>
          </tr>
        </thead>
        <tbody>
          {lineItems.map((item, idx) => (
            <tr key={idx} className="items-row">
              ...
              <td className="items-cell items-barcode" style={{ fontWeight: 'bold', border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>{item.barcode}</td>
              <td className="items-cell items-description" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>{item.itemName}</td>
          ...
          {Array.from({ length: fillerCount }).map((_, i) => (
            <tr key={`filler-${i}`} className="items-row" style={{ visibility: 'hidden' }}>
              ...
              <td className="items-cell" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>&nbsp;</td>
              <td className="items-cell items-description" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>PLACEHOLDER</td>
              <td className="items-cell" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>&nbsp;</td>
              <td className="items-cell" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>&nbsp;</td>
              <td className="items-cell" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>&nbsp;</td>
              <td className="items-cell" style={{ border: borderStyle, borderBottom: 'none', borderTop: 'none' }}>&nbsp;</td>
